        ...
        drawResults() {
            ...
            this.results.buttons.forEach(b => {
                ...
                if (b.claimedFrame) {
                    ...
                    //Draw stuff
                    this.mouseButton.push(this.add.text(x + 2, 315, `${Phaser.Math.FloorTo(b.firstFrame, -2)}`, this.smallText));
                    ...
                    this.graphics.strokeLineShape(clickStartLine);
                    this.mouseButton.push(this.add.text(x + 2, y, `Button: ${b.button}
            ...
            if (this.nextUnclaimed < this.moveFrames.length) {
                ...
                if (c.firstFrame > this.pushCount + jf.earlyFrame - 1) {
                    ...
                    if (c.firstFrame < this.pushCount + jf.latestFrame + 1) {
                        ...
                        if (c.firstFrame < jf.earlyFrame + Math.floor(this.pushCount))
